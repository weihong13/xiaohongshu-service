...
import com.guoshisan.xiaohongshu.user.biz.constant.RedisKeyConstants;
import com.guoshisan.xiaohongshu.user.biz.constant.RoleConstants;
...
import com.guoshisan.xiaohongshu.user.biz.mapper.RoleDTOMapper;
...
public class UserServiceImpl implements IUserService {
    ...
    @Resource
    private UserRoleDTOMapper userRoleDOMapper;
    @Resource
    ...
    public Response<Long> register(RegisterUserReqDTO registerUserReqDTO) {
        ...
        // 先判断该手机号是否已被注册
        UserDTO userDO1 = userDTOMapper.selectByPhone(phone);
        ...
        RoleDTO roleDO = roleDOMapper.selectByPrimaryKey(RoleConstants.COMMON_USER_ROLE_ID);
